      ...
      <div className="max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-6 space-y-4 text-center lg:text-left">
            ...
            {/* Animated Minimal Badge */}
            <div className="inline-flex items-center gap-1.5 px-3.5 py-1.5 rounded-full bg-white/90 dark:bg-warmgray-800/90 backdrop-blur-xs border border-bloom-200 dark:border-bloom-800/60 text-bloom-700 dark:text-bloom-300 text-xs font-bold shadow-xs animate-bounce-subtle">
            ...
            {/* Clean Action Buttons with Shimmer and Hover Lift */}
            ...
            {/* Simple 1-Line Trust Note with subtle glow */}
            <p className="text-xs text-warmgray-500 dark:text-warmgray-400 pt-1 flex items-center justify-center lg:justify-start gap-1.5">
          ...
          {/* Right: Clean, Beautiful Visual Card with Floating Accents */}
          <div className="lg:col-span-6">
            <div className="relative mx-auto max-w-sm lg:max-w-md">
              
              {/* Floating Decorative Accent 1 */}
              <div className="absolute -top-3 -left-3 z-20 px-3 py-1.5 rounded-2xl bg-white/95 dark:bg-warmgray-800/95 backdrop-blur-xs border border-bloom-100 dark:border-warmgray-700 shadow-lg text-[11px] font-bold text-bloom-600 dark:text-bloom-400 flex items-center gap-1.5 animate-float-slow pointer-events-none">
                <Flower2 className="w-3.5 h-3.5 text-bloom-500 animate-spin-slow" />
                <span>Everlasting Petals</span>
              </div>

              {/* Floating Decorative Accent 2 */}
              <div className="absolute -bottom-3 -right-3 z-20 px-3 py-1.5 rounded-2xl bg-white/95 dark:bg-warmgray-800/95 backdrop-blur-xs border border-rosewood-100 dark:border-warmgray-700 shadow-lg text-[11px] font-bold text-rosewood-600 dark:text-rosewood-400 flex items-center gap-1.5 animate-float-reverse pointer-events-none">
