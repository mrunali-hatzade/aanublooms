...
export const AdminDashboard = ({ onNavigate }) => {
  ...
  const [activeTab, setActiveTab] = useState('orders'); // 'orders' | 'products' | 'commissions' | 'messages'
  ...
  const fetchData = async () => {
    setIsLoading(true);
    try {
      const [analyticsRes, ordersRes, productsRes, customRes, contactRes] = await Promise.all([
        api.getAnalytics(),
        api.getOrders(),
        api.getProducts(),
  ...
  return (
    <div className="py-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <div className="flex items-center gap-2 mb-1">
            <span className="px-3 py-1 rounded-full bg-amber-100 dark:bg-amber-950 text-amber-800 dark:text-amber-300 text-xs font-bold uppercase tracking-wider flex items-center gap-1.5">
        ...
        <div className="flex gap-2">
          <button
            ...
            className="px-5 py-3 bg-bloom-500 hover:bg-bloom-600 text-white rounded-2xl font-bold text-xs shadow-cozy flex items-center gap-2"
          >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
        <div className="p-6 rounded-3xl bg-white dark:bg-warmgray-900 border border-warmgray-200/80 dark:border-warmgray-800 shadow-soft">
          <div className="flex items-center justify-between text-warmgray-500 mb-2">
          ...
          <p className="text-3xl font-serif font-bold text-warmgray-900 dark:text-white">
        ...
        <div className="p-6 rounded-3xl bg-white dark:bg-warmgray-900 border border-warmgray-200/80 dark:border-warmgray-800 shadow-soft">
          <div className="flex items-center justify-between text-warmgray-500 mb-2">
            ...
            <div className="w-8 h-8 rounded-xl bg-bloom-100 dark:bg-bloom-950 text-bloom-600 flex items-center justify-center">
        ...
        <div className="p-6 rounded-3xl bg-white dark:bg-warmgray-900 border border-warmgray-200/80 dark:border-warmgray-800 shadow-soft">
          <div className="flex items-center justify-between text-warmgray-500 mb-2">
            ...
            <div className="w-8 h-8 rounded-xl bg-rosewood-100 dark:bg-rosewood-950 text-rosewood-600 flex items-center justify-center">
      ...
      {/* Tabs */}
      <div className="flex gap-3 border-b border-warmgray-200 dark:border-warmgray-800 pb-2 overflow-x-auto">
        {[
      ...
      {activeTab === 'orders' && (
        <div className="bg-white dark:bg-warmgray-900 rounded-3xl p-6 border border-warmgray-200/80 dark:border-warmgray-800 shadow-soft space-y-6">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-between items-center">
            <div className="relative w-full sm:w-72">
              ...
              <input
                ...
                className="w-full text-xs py-2.5 pl-10 pr-4 rounded-xl bg-warmgray-50 dark:bg-warmgray-800 border border-warmgray-200 dark:border-warmgray-700 text-warmgray-900 dark:text-white"
              />
            </div>
            ...
            <table className="w-full text-xs text-left">
              <thead>
                <tr className="border-b border-warmgray-200 dark:border-warmgray-800 text-warmgray-400 uppercase tracking-wider text-[10px]">
                  ...
                  <th className="py-3 px-3">Current Craft Stage</th>
              ...
              <tbody className="divide-y divide-warmgray-100 dark:divide-warmgray-800">
                {filteredOrders.map(order => (
                  <tr key={order.id} className="hover:bg-warmgray-50/50 dark:hover:bg-warmgray-800/40 transition-colors">
                    ...
                    <td className="py-4 px-3 font-serif font-bold text-warmgray-900 dark:text-white">
                    ...
                    <td className="py-4 px-3">
                      ...
                      >
                        ...
                        <option value="packaging">🌸 Quality & Ribbon Packaging</option>
                    ...
                    <td className="py-4 px-3 text-right">
                      <button
                        ...
                        className="px-3 py-1.5 bg-warmgray-100 hover:bg-warmgray-200 dark:bg-warmgray-800 text-warmgray-800 dark:text-warmgray-200 rounded-lg text-[11px] font-bold inline-flex items-center gap-1"
                      >
      ...
      {activeTab === 'products' && (
        <div className="bg-white dark:bg-warmgray-900 rounded-3xl p-6 border border-warmgray-200/80 dark:border-warmgray-800 shadow-soft space-y-6">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {products.map(prod => (
              <div key={prod.id} className="p-4 rounded-2xl border border-warmgray-200 dark:border-warmgray-800 flex gap-4 bg-warmgray-50/50 dark:bg-warmgray-800/40">
                <img src={prod.images?.[0]} alt={prod.name} className="w-20 h-20 rounded-xl object-cover shrink-0" />
                <div className="flex-1 min-w-0 flex flex-col justify-between">
                  <div>
                    <h4 className="font-serif font-bold text-sm text-warmgray-900 dark:text-white truncate">{prod.name}</h4>
                    <p className="text-xs text-bloom-600 dark:text-bloom-400 font-bold">${prod.price.toFixed(2)}</p>
                  ...
                  <div className="flex gap-2 mt-2">
                    <button
                      ...
                      className="px-2.5 py-1 bg-warmgray-200 dark:bg-warmgray-700 hover:bg-warmgray-300 text-warmgray-800 dark:text-warmgray-200 rounded-lg text-[11px] font-bold flex items-center gap-1"
                    >
                    ...
                    <button
                      ...
                      className="px-2.5 py-1 bg-red-100 hover:bg-red-200 text-red-700 dark:bg-red-950 dark:text-red-300 rounded-lg text-[11px] font-bold flex items-center gap-1"
                    >
      ...
      {activeTab === 'commissions' && (
        <div className="bg-white dark:bg-warmgray-900 rounded-3xl p-6 border border-warmgray-200/80 dark:border-warmgray-800 shadow-soft space-y-4">
          ...
          <div className="space-y-4">
            {customRequests.map((comm) => (
              <div key={comm.id} className="p-5 rounded-2xl border border-warmgray-200 dark:border-warmgray-800 bg-warmgray-50 dark:bg-warmgray-800/50 space-y-2">
                ...
                <p className="text-xs text-warmgray-700 dark:text-warmgray-300 bg-white dark:bg-warmgray-900 p-3 rounded-xl border border-warmgray-100 dark:border-warmgray-700">
                  {comm.specialNotes}
                </p>
              </div>
            ))}
      ...
      {activeTab === 'messages' && (
        <div className="bg-white dark:bg-warmgray-900 rounded-3xl p-6 border border-warmgray-200/80 dark:border-warmgray-800 shadow-soft space-y-4">
          ...
          {contactMessages.length === 0 ? (
            <div className="text-center py-10 text-xs text-warmgray-500">
              No customer messages yet.
            </div>
          ) : (
            <div className="space-y-4">
              {contactMessages.map((msg) => (
                <div key={msg.id} className="p-5 rounded-2xl border border-warmgray-200 dark:border-warmgray-800 bg-warmgray-50 dark:bg-warmgray-800/50 space-y-2">
                  <div className="flex justify-between items-start">
                    <div>
      ...
      {showProductModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-xs overflow-y-auto">
          <div className="relative bg-white dark:bg-warmgray-900 rounded-3xl p-6 sm:p-8 max-w-xl w-full border border-warmgray-200 dark:border-warmgray-800 shadow-2xl z-10 my-8">
