    ...
    <div className="py-12 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 min-h-[70vh]">
      ...
      {wishlist.length === 0 ? (
        <div className="py-20 text-center max-w-md mx-auto">
          <div className="w-16 h-16 rounded-full bg-rosewood-50 dark:bg-warmgray-800 text-rosewood-500 mx-auto flex items-center justify-center mb-4">
          ...
          <button
            ...
            className="px-6 py-3 bg-bloom-500 hover:bg-bloom-600 text-white rounded-full font-bold text-xs shadow-cozy inline-flex items-center gap-2"
          >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {wishlist.map(item => (
            <div
              key={item.id}
              className="bg-white dark:bg-warmgray-900 rounded-3xl overflow-hidden border border-warmgray-200 dark:border-warmgray-800 shadow-soft flex flex-col justify-between"
            >
              <div
                onClick={() => onNavigate('product-detail', { id: item.id })}
                className="cursor-pointer"
              >
                <div className="aspect-square w-full bg-warmgray-100 dark:bg-warmgray-800 relative">
                  ...
                  <button
                    ...
                    className="absolute top-3 right-3 p-2 bg-white/90 dark:bg-warmgray-900/90 rounded-full text-red-500 shadow-md"
                  >
              ...
              <div className="p-4 pt-0">
                <button
                  ...
                  className="w-full py-2.5 bg-bloom-500 hover:bg-bloom-600 text-white rounded-xl font-bold text-xs shadow-xs flex items-center justify-center gap-1.5"
                >
