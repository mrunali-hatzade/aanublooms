...
import { Sparkles, ArrowRight, Heart, Flower2, Star } from 'lucide-react';
    ...
    <div className="space-y-16">
      ...
      <section className="py-12 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 mb-10">
          ...
          {/* Filter tabs */}
          <div className="flex gap-2 bg-warmgray-100 dark:bg-warmgray-800/80 p-1.5 rounded-2xl self-start">
            {[
        ...
        <div className="mt-12 text-center">
          <button
            ...
            className="px-8 py-3.5 bg-warmgray-900 hover:bg-black text-white dark:bg-warmgray-800 dark:hover:bg-warmgray-700 rounded-full font-bold text-xs shadow-md transition-all inline-flex items-center gap-2"
          >
      ...
      <section className="py-12 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-gradient-to-r from-bloom-500 via-rosewood-500 to-amber-500 rounded-3xl p-8 sm:p-12 text-white shadow-soft-lg flex flex-col md:flex-row items-center justify-between gap-8 relative overflow-hidden">
          <div className="max-w-xl relative z-10">
            <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-white/20 text-xs font-bold uppercase tracking-wider mb-3">
              <Flower2 className="w-3.5 h-3.5" />
              Bespoke Studio Commissions
            </span>
            <h3 className="text-3xl sm:text-4xl font-serif font-bold mb-3">
              Need a personalized floral bouquet or custom plushie?
            </h3>
            <p className="text-rose-100 text-sm leading-relaxed mb-6">
              Choose your favorite yarn color palette, combine flower stems, and add an embroidered ribbon message for weddings, anniversaries, graduations, or cherished home styling.
            </p>
            <button
              onClick={() => onNavigate('custom-order')}
              className="px-8 py-3.5 bg-white hover:bg-rosewood-50 text-warmgray-900 rounded-full font-bold text-xs shadow-lg transition-transform hover:scale-105"
            >
          ...
          <div className="relative shrink-0">
            <img
              ...
              alt="Custom bouquet"
              className="w-64 h-64 rounded-3xl object-cover border-4 border-white/30 shadow-2xl rotate-2 hover:rotate-0 transition-transform duration-300"
            />
          </div>
        </div>
      </section>
