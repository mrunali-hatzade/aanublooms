...
export const HomePage = ({ onNavigate }) => {
  ...
  return (
    <div className="space-y-8 sm:space-y-10">
      ...
      {/* 5. Centered "Best Sellers" Section */}
      <section id="home-bestsellers" className="py-4 sm:py-6 max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-8 animate-reveal-up delay-200">
        <div className="text-center max-w-md mx-auto mb-6">
          <div className="flex items-center justify-center gap-2 text-bloom-700 mb-1">
            <span className="h-px w-10 bg-bloom-700/40"></span>
        ...
        <div className="mt-8 text-center animate-reveal-up delay-400">
          <button
            ...
            className="px-7 py-2.5 bg-honey-500 hover:bg-honey-600 text-white rounded-xl font-bold text-xs shadow-sm transition-all inline-flex items-center gap-2"
          >
      ...
      <section className="py-6 sm:py-8 bg-gradient-to-r from-bloom-800 via-bloom-700 to-[#5E2B38] text-white shadow-soft relative overflow-hidden animate-reveal-up delay-400">
        ...
        <div className="max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-8 relative z-10 flex flex-col sm:flex-row items-center justify-between gap-6 text-center sm:text-left">
          <div className="space-y-2">
            <h3 className="font-serif font-bold text-xl sm:text-2xl flex items-center justify-center sm:justify-start gap-2">
              <Sparkles className="w-5 h-5 text-honey-300 animate-spin-slow" />
              <span>Follow Our Studio Journey</span>
            </h3>
            <p className="text-sm text-bloom-100 max-w-xl">
          ...
          <a
            ...
            className="px-6 py-3 bg-white text-bloom-900 hover:bg-bloom-50 rounded-xl font-bold text-sm shadow-md btn-shimmer transition-all duration-300 transform hover:-translate-y-0.5 active:scale-95 inline-flex items-center gap-2 shrink-0 group"
          >
      ...
      <section className="py-4 sm:py-6 max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-8 animate-reveal-up delay-450">
        <div className="bg-gradient-to-r from-bloom-800 via-[#794150] to-[#5E2B38] rounded-3xl p-6 sm:p-10 text-white shadow-soft-lg flex flex-col md:flex-row items-center justify-between gap-6 relative overflow-hidden group">
